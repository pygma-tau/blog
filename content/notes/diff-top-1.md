...
**(Lee 1.7)** Let $N,S$ be the north and south poles of $\mathbb{S}^n$ embedded with unit radius in $\mathbb{R}^{n+1}$. Below we discuss various properties of the stereographic projection $\sigma: \mathbb{S}^n \setminus \\{N\\} \to \mathbb{R}^n,$ where 
$$
...
**Problem.** Prove that the antipodal map $\alpha: \mathbb{S}^n \to \mathbb{S}^n$ given by $\alpha(x) = -x$ is smooth.
